    ...
    def validate(self, do_mirroring: bool = True, use_train_mode: bool = False, tiled: bool = True, step: int = 2,
        ...
        for k in self.dataset_val.keys():
            ...
            if overwrite or (not isfile(join(output_folder, fname + ".nii.gz"))) or \
                ...
                if config.DEBUG_MODE: # zhuc
                    results.append(save_segmentation_nifti_from_softmax(softmax_pred, join(output_folder, fname + ".nii.gz"),
            ...
            pred_gt_tuples.append([join(output_folder, fname + ".nii.gz"),
                                   ...
                                   join(self.gt_niftis_folder, properties['seg_file'].split(os.sep)[-1])]) # zhuc
        ...
        determine_postprocessing(self.output_folder, self.gt_niftis_folder, validation_folder_name,
                                 ...
                                 processes=default_num_threads, f_dict=self.dataset)
