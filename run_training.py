...
def main():
    ...
    parser.add_argument("-network", default="3d_fullres", help="could be 2d, 3d_lowres, 3d_fullres")
    parser.add_argument("-network_trainer", default="nnUNetTrainerV2")
    parser.add_argument("-task", default="004", help="can be task name or task id")
    ...
    if not task.startswith("Task"):
        task_id = int(task)
        # TODO: can't find task when run nnunet/run/run_training.py
